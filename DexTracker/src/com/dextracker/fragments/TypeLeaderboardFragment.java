...
public class TypeLeaderboardFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View rootView = inflater.inflate(R.layout.leaderboard_type_fragment, container, false);
		lv = (ListView) rootView.findViewById(R.id.typeListView);
